...
class HomeEmployeePageView extends StatelessWidget {
  const HomeEmployeePageView({super.key});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<HomeEmployeePageViewModel>.reactive(
        viewModelBuilder: () => HomeEmployeePageViewModel(),
