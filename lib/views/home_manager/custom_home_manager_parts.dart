part of 'home_manager_page_view.dart';


customForButton(context,HomeManagerPageViewModel model, title,index) {
  return AnimatedContainer(
    duration: const Duration(milliseconds: 200),
    width: customWidth(context,
        percentage: model.isForYouBtnSelected ==index? 0.38 : 0.34),
    height: customHeight(context,
        percentage: model.isForYouBtnSelected==index ? 0.06 : 0.05),
    child: ElevatedButton(
      ...
      onPressed: () {
        model.isForYouBtnSelected = index;
        model.lIndex=index;
      ...
      child: AutoSizeText(
        title,
        maxFontSize: model.lIndex ==index? 12:10,//customHeight(context, percentage: 0.012):customHeight(context, percentage: 0.01),
        minFontSize: model.lIndex ==index? 10:8,//customHeight(context, percentage: 0.01):customHeight(context, percentage: 0.009),
        style: TextStyle(
            fontWeight: model.lIndex ==index? FontWeight.bold:FontWeight.normal,
...
customFromButton(context, model, title) {
  return AnimatedContainer(
    duration: const Duration(milliseconds: 200),
    width: customWidth(context,
